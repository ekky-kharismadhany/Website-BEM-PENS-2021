        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container">
                        <h3 class="font-bold">News Section</h3>
                        <p>This section allow member to add event related to their respective ministry</p>
                        <button class="bg-gray-600 hover:bg-gray-400 text-white py-2 px-4 rounded p-4"><a href="{{route('calendar.add')}}">Add Event</a></button>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="ml-4">
                                                                ...
                                                                <div class="text-sm text-gray-500">
                                                                    {{auth()->user()->kementerian}}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">{{$event->Deskripsi}}</div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <button class="bg-green-600 hover:bg-green-400 text-white py-2 px-4 rounded p-4"><a href="{{route('calendar.edit', ['id' => $event->id])}}">Edit</a></button>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
